...
<head>
    ...
    <style type="text/css">
        ...
        .update_main{width:1200px; margin:0 auto;}

        .textbox{width:100%; height:300px; background-color:#f5f5f5;
        ...
        .check_btn {background-color:rgb(68, 68, 68); color:white; font-size:20px;
        padding:5px 50px 5px 50px; font-family:"Noto Sans CJK KR";}
    ...
    <!--//header-->
        ...
        <div class="main">
            ...
            <form method="post" action="m_update_form.php?rowx=<?php echo $idx?>">
                <div class="update_main">
                    <div class="main_notice">
                        <p>·  에뛰드는 회원님의 개인정보를 신중히 취급하며, 회원님의 동의 없이는 기재하신 회원정보가 공개되지 않습니다.</p>
                        <p>·  보다 다양한 서비스를 받으시려면 정확한 정보를 항상 유지해 주셔야 합니다.</p>
                    </div>
                    <div class="textbox"> 
                            ...
                            <div class="textbox_inner">
                                <table>
                                    ...
                                    <tr class="id_pass">
                                        ...
                                        <td><button class="check_btn" type="submit"> 확인</button></p></td>
                                    </tr> 
                                </table> 
                            </div>
                        </div>

...
.main_container{width:1000px; height:auto;  margin:0 auto; margin-bottom:60px;}
.main_container h1{font-size:30px;margin-top:40px; font-weight:bold; text-align:center; font-family: "Noto Sans CJK KR";}
.member{border-top: 1px solid black; border-bottom:1px solid black; border-collapse: collapse; margin-left:30px;}
...
.member td{ padding:10px 30px 10px 30px; font-size:20px;}
    ...
    <div class="container">    
        ...
        <h1>회원 정보</h1>
            <table class="member">
                <tr>
                    <th class="m_title">#</th>
                    <th class="m_title">이름</th>
                    <th class="m_title">아이디</th>
                    <th class="m_title">비밀번호</th>
                    <th class="m_title">전화번호</th>
                    <th class="m_title">등록 날짜</th>
                </tr>

<?php

$sql = "select * from member_t order by id desc";
$result = mysqli_query($conn, $sql);

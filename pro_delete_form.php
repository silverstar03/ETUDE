...
$sql = "select * from product where id=$_idx";
...
.delete_main h3{font-size:30px; font-weight:bold; text-align:center; margin-top : 30px;
margin-bottom:30px;}
.delete_box{width:500px; margin: 0 auto;margin-bottom:30px; border:6px solid #f5f5f5;}
.delete_cont p{font-size:15px; font-weight:600; padding:10px; text-align:center;}
.delete_cont input[type="text"]{
    line-height:normal;
...
.delete_cont input:hover{
    cursor:no-drop;
}
.delete_next{width:120px; margin:0 auto;}
.delete_btn{border-radius:35px; border: 2px solid #7993b2; padding:10px 40px 10px 40px; background-color:white; margin-bottom:30px; margin-top:30px;}
.p_title{width:150px; padding-left:30px; font-size:15px; background-color:pink; }
...
footer{ width: 100%; height: 350px; background-color:#f5f5f5; clear:both;}
        ...
        <!--//header-->
            ...
            <div class="main">
                <div class="container">              
                <form method="post" action="pro_delete.php?idx=<?php echo $re['id']?>">
                    <div class="container">
                            ...
                            <div class="delete_box"> 
                                <div class="delete_cont">
                                    ...
                                    <tr class="update">
                                        ...
                                        <td class="p_name"><input type="text" name="p_name" value="<?php echo $re['p_name'] ?>" readonly></td>
                                    <tr class="update">
                                        <td class="p_title">가격</td>
                                        <td class="p_price"><input type="text" name="p_price" value="<?php echo $re['p_price'] ?>" readonly></td>
                                    </tr>
                                    <tr class="update">
                                        <td class="p_title">제품 사진</td>
                                        <td class="p_img"><input type="text" name="p_path" value="<?php echo $re['p_path'] ?>" readonly></td>
                                    </tr>
                                    <tr class="update">
                                        <td class="p_title">수량</td>
                                        <td class="p_cnt"><input type="text" name="p_cnt" value="<?php echo $re['p_cnt'] ?>" readonly></td>
                                    </tr>
                                </table> 
                                </div>

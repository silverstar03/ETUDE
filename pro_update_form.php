...
.update_next{width:150px; margin:0 auto;}
.update_btn{border-radius:35px; border: 2px solid #7993b2; padding:10px 40px 10px 40px; background-color:white; margin-bottom:30px; margin-top:30px;}
...
footer{ width: 100%; height: 350px; background-color:#f5f5f5; clear:both;}
        ...
        <!--//header-->
            ...
            <div class="main">
                <div class="container">              
                <form method="post" action="pro_update.php?idx=<?php echo $re['id']?>" enctype="multipart/form-data">
                    <div class="container">
                            ...
                            <div class="delete_box"> 
                                <div class="delete_cont">
                                    ...
                                    <tr class="update">
                                        ...
                                        <td class="p_name"><input type="text" name="p_name" value="<?php echo $re['p_name'] ?>" ></td>
                                    <tr class="update">
                                        <td class="p_title">가격</td>
                                        <td class="p_price"><input type="text" name="p_price" value="<?php echo $re['p_price'] ?>" ></td>
                                    </tr>
                                    <tr class="update">
                                        <td class="p_title">제품 사진</td>
                                        <td class="p_img"><input type="file" name="userfile" multiple="multiple"  required ></td>
                                    </tr>
                                    <tr class="update">
                                        <td class="p_title">수량</td>
                                        <td class="p_cnt"><input type="text" name="p_cnt" value="<?php echo $re['p_cnt'] ?>"></td>
                                    </tr>
                                </table> 
                                </div>
                                
                                <div class="update_next">
